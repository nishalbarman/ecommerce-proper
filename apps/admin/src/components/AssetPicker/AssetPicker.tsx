  ...
  return (
    <>
      <div
        ...
        // htmlFor={`${htmlFor}`}
        className={`cursor-pointer bg-white p-4 rounded-md border-2 border-dashed border-red-600 mt-1 w-full zoom-normal w-full ${classX}`}>
        <div className="flex flex-row items-center justify-center gap-3 h-full w-full">
          <svg viewBox="0 0 640 512" className="h-5 fill-red-600">
