    ...
    <>
      {
        <div className="fixed inset-0 z-50 w-full h-full flex justify-center overflow-x-hidden overflow-y-hidden outline-none focus:outline-none md:p-10 ">
          ...
          <div className="border border-gray-200 shadow-lg relative flex flex-col max-xl:w-full w-1/2 bg-white outline-none focus:outline-none rounded-md">
            ...
            <div className="relative md:p-6 flex-auto overflow-auto flex items-center justify-center w-full bg-gray-100 rounded-md">
              <img
                style={{
