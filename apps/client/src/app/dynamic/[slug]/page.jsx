        ...
        <div className="container px-5 py-4 md:py-10 lg:15 mx-auto flex flex-col">
          <div className="lg:w-5/6 mx-auto">
            ...
            <div className="flex flex-col sm:flex-row mt-10">
              {pageContent?.avatar && pageContent?.shortDescription && (
              ...
              <div
                className={`sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t pt-10 sm:mt-0 ${(!pageContent?.avatar || !pageContent?.shortDescription) && "mx-auto border-none px-4 -mt-15"}`}>
