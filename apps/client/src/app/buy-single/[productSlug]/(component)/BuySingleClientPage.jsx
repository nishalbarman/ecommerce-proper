...
import { useGetBuySingleProductQuery } from "@/redux/apis/productApi";

export default function BuySingleClientData({ initialProductData }) {
  ...
  const { data: productData, isLoading: isProductDataLoading } =
    useGetBuySingleProductQuery(
      ...
      {
        skip: !params.productSlug || initialProductData,
        refetchOnMountOrArgChange: true,
        selectFromResult: (result) => {
          console.log("Result from RTK Query", result);
          return {
            ...result,
  ...
  console.log("Product data on client", initialProductData);
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-2/3">
                ...
                {isClient && images.length > 0 ? (
                  <>
                    ...
                    <Swiper
                      ...
                      spaceBetween={10}
                      slidesPerView={1}
                      className={`my-swiper w-full max-sm:h-[200px] h-[400px] bg-gray-50 max-md:h-[320px] aspect-square rounded-lg shadow-lg mb-4 flex items-center justify-center`}>
                      {/* Slider Images */}
                  ...
                  <>
                    {/* Main Image */}
                    <div className="my-swiper w-full max-sm:h-[200px] h-[400px] bg-gray-50 max-md:h-[320px] aspect-square rounded-lg shadow-lg mb-4 flex items-center justify-center">
                      <img
                        style={{
            ...
            <div className="mt-5">
              ...
              <div className="">
                <div className="">
                  <div className="flex justify-between items-center mb-4 mt-2 max-sm:mt-1">
                    <p className="text-sm font-bold text-gray-600 border-l-5 border-l-primary pl-1">
                      {productData && productData?.category?.categoryName}
                    </p>
                  </div>
                  {/* Cart Items List */}
                    ...
                    <div className="flex flex-col md:flex-row p-4 gap-4">
                      ...
                      <div className="flex-1 flex flex-col">
                        <div className="flex justify-between items-start">
                          <Link
                            href={`/products/view/${productData?.product?._id || productData?._id}`}
                            className="max-md:text-lg min-md:text-xl font-bold text-gray-800 transition-colors hover:text-primary">
                            {productData?.title}
                          </Link>
                        </div>
                  ...
                  {productData?.description && (
                    <div
                      className="max-lg:hidden prose prose-stone mt-10"
          ...
          {/* Right Side */}
          <div className="lg:w-1/2 max-lg:-mt-7">
            <button
              onClick={handleContinueToPayment}
              disabled={!selectedAddress || isPaymentLoading}
              className={`w-full py-3 px-6 mb-5 rounded-xl font-bold text-white transition-colors text-white ${
                !selectedAddress
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 transition-all mb-5">
              ...
              {!isOpen && selectedAddressData && selectedAddress && (
                <>
                  <h3 className="text-sm max-md:text-md font-medium text-gray-800 -mt-2 mb-2">
                    Selected Address
                  </h3>
                  <div
                    onClick={() => setIsOpen((prev) => !prev)}
            ...
            <div className="mt-4 bg-white rounded-xl shadow-sm border border-gray-200 min-lg:sticky min-lg:top-4">
              <div className="p-6">
                ...
                <div className="bg-white rounded-xl mt-5">
                  {/* <h2 className="text-sm text-gray-900 mb-2 mt-2">
            ...
            {productData?.description && (
              <div
                className="min-lg:hidden prose prose-stone mt-10"
                dangerouslySetInnerHTML={{
                  __html: productData?.description,
                }}
              />
