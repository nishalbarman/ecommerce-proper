  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="bg-white rounded-2xl shadow-sm border p-5 sm:p-6 max-w-3xl mx-auto">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-lg border bg-gray-50 hover:bg-gray-100 text-gray-700 disabled:opacity-50">
                  {uploading ? (
