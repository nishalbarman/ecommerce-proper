  ...
  return (
    <div className="bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {/* Orders CTA strip (mirrors your “View All” style) */}
...
function ProfileCard({ href, title, description, icon }) {
  return (
    <Link
      href={href}
      className="group bg-white rounded-2xl border shadow-sm hover:shadow-md transition-all p-4 sm:p-5 flex items-start gap-4">
